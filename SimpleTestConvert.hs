...
main = do
    ...
    putStrLn testCode
    putStrLn "----------------------------"
    putStrLn . display False . nub . convertGrammar . parseTopLevel $ testCode
    ...
    putStrLn test2Code
    putStrLn "----------------------------"
    putStrLn . display False . nub . convertGrammar . parseTopLevel $ test2Code
    ...
    putStrLn test3Code
    putStrLn "----------------------------"
    putStrLn . display False . nub . convertGrammar . parseTopLevel $ test3Code
    ...
    putStrLn test4Code
    putStrLn "----------------------------"
    putStrLn . display False . nub . convertGrammar . parseTopLevel $ test4Code
    -- a bug that some rules might be produced duplicated